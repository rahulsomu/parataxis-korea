...
const Contact = () => {
  ...
  return (
    ...
    <div className="video-background">
      <video autoPlay muted loop playsInline poster={'https://parataxis.sfo2.digitaloceanspaces.com/Photos/poster.jpeg'}>
    ...
    <div className="contact-content">
      <div className="contact-strip">
        ...
        <div className="contact-group">
          ...
          <a href="mailto:investor@parataxis.co.kr">investor@parataxis.co.kr</a>
        </div>
        <div className="contact-divider"></div>
        <div className="contact-group">
