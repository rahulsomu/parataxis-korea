...
import { DATE_FORMAT, webcastsApiUrl } from "../../constants";
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      setWebcastsData({
        ...
        data: [],
        error:
          error.message || "Failed to fetch Webcasts and Presentations data",
      });
    }
  };
      ...
      {!isEmpty(relatedVideos) && (
        <div className="related-videos">
          ...
          {relatedVideos.length >= 4 && (
            <Link to="/webcasts" className="view-all-button">
